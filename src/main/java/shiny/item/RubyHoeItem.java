...
import shiny.procedures.RubyHoeRightclickedOnBlockProcedure;
...
public class RubyHoeItem extends Item {
	public RubyHoeItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		RubyHoeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ());
