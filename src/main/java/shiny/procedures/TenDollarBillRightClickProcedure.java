...
public class TenDollarBillRightClickProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		{
			ShinyModVariables.PlayerVariables _vars = entity.getData(ShinyModVariables.PLAYER_VARIABLES);
			_vars.MoneyCount = entity.getData(ShinyModVariables.PLAYER_VARIABLES).MoneyCount + (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getCount() * 10;
